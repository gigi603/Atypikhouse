...
@section('title', "Détails de la réservation atypikhouse annulée")
@section('content')
<div class="admin-user-profil">
    ...
    <div class="container list-category">
        <div class="panel panel-default">
            <div class="panel-heading"><h1 style="font-size:20px;">Détails de la réservation atypikhouse annulée</h1></div>

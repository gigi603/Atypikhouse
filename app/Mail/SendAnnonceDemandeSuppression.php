...
class SendAnnonceDemandeSuppression extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from('notre.equipe.atypikhouse@gmail.com')
            ->subject('Confirmation de la demande de suppression de votre annonce')
            ->view('email.annonceDemandeSuppressionConfirmation')
            ->with([

                ...
                for (i in data.proprietes) {
                    if (idArr.indexOf(data.proprietes[i].id) !== -1) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="checkbox" disabled checked class="checkbox_propertie" name="propriete[]" autofocus value="${data.proprietes[i].id}"/>
                            </div>
                        </div>`);
                    } else {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="checkbox" disabled class="checkbox_propertie" name="propriete[]" autofocus value="${data.proprietes[i].id}"/>
                            </div>
                        </div>`);
                    }
                }
